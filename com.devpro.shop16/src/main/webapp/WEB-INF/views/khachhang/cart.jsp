...
<main class="container">
    ...
    <div class="content">
                ...
                <c:forEach items="${cart.cartItems }" var="ci">
                    <tr>
                        <th scope="row" class="border-0">
                            <div class="p-2">
                                <img src="${base }/upload/${ci.productPictures}" alt="" width="70"
        ...
        <!-- End -->
        <form action="${base }/cart/checkout" method="post" onsubmit="submitOrder(event)">
            <div>
...
<script>
    ...
    async function submitOrder(event) {
        ...
        if (!validateOrder()) {
            showNotification("Thông tin không hợp lệ. Vui lòng kiểm tra lại.", "error");
            return;
        }
...
<script type="text/javascript">
    ...
    function validatePhone() {
        ...
        if (phoneValue.length !== 10 || !/^\d+$/.test(phoneValue)) {
            setErrorFor(phoneInput, "Nhập đúng định dạng số điện thoại (10 số)");
            return false;
        } else {
