		...
		<div class="contact">
			...
			<div class="call">
				...
				<div class="call-title">
					Hỗ trợ / Mua hàng: <span class="call-phone">0787064948</span>
				</div>
			</div>
		</div>
	...
	<div class="introduc">
		<div class="introduc-content">
			...
			<div class="introduc-logo">
				<div>TẤT CẢ CÁC SẢN PHẨM ĐỀU ĐƯỢC NHẬP KHẨU CHÍNH NGẠCH</div>
		...
		<div class="introduc-contact">
			...
			<div class="introduc-list">
				<ul>
					<li><i class="fas fa-map-marker-alt"></i> 80/36 Xuân Phương,Phương Canh,Nam Từ Liêm Hà Nội</li>
					<li><i class="fas fa-phone-volume"></i> 0787064948</li>
					<li><i class="fas fa-phone-volume"></i> 0868773062</li>
					<li><i class="fas fa-paper-plane"></i> nguyenquoctuan.work@gmail.com
					</li>
				</ul>
			</div>
		</div>
