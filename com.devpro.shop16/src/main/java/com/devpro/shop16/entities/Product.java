...
public class Product extends BaseEntity{
	...
	public Product(String title, BigDecimal price, BigDecimal price_sale, String shortDes, Integer quantity,
			Integer productStatus, String details, String avatar, String seo, Categories categories,
